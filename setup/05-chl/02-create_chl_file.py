...
#wifs = xr.open_dataset("https://basin.ceoe.udel.edu/thredds/fileServer/SEAWIFSDAILY9KM.nc").sel(lat=slice(-55,5), lon=slice(-80,-20))
...
print(wifs_mon)
wifs_mon.to_netcdf("seawifs-clim.2001-2015.nc") #, format='NETCDF4')

# we ran the code above on another machine and saved the file. Open this file up
wifs = xr.open_dataset("seawifs-clim.2001-2015.nc")
...
hgrid = xr.open_dataset("/Volumes/A1/workdir/nicole/SWA14/grid/ocean_hgrid.nc")
...
ds.to_netcdf('/home/nicole/workdir/SWA14/INPUT/chl_mom6.nc', 
    encoding=encodings, 
    format='NETCDF4',
    unlimited_dims='time'
)
